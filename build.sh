...
<header>
  ...
  <nav class="tabs">
    <button class="tab-btn active" data-tab="sw">SW Team Ratings</button>
    ...
    .forEach(team => {
      ...
      thead.innerHTML =
        ...
        '<div class="sw-team-stats">' +
          '<div class="sw-stat"><span class="sw-stat-val">' + team.gamesRoster + '</span><span class="sw-stat-lbl">Games/Roster</span></div>' +
          '<div class="sw-stat"><span class="sw-stat-val">' + team.avgPTI.toFixed(2) + '</span><span class="sw-stat-lbl">Avg. PTI</span></div>' +
          '<div class="sw-stat"><span class="sw-stat-val">' + computeAdjAvgPTIPerGame(team.name, team.avgPTIPerGame).toFixed(2) + '</span><span class="sw-stat-lbl">Avg. PTI/Game</span></div>' +
        '</div>';
